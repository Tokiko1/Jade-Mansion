...
/mob/living/verb/ghost()
	...
	if(stat == DEAD)
		...
		var/response = alert(src, "Are you -sure- you want to ghost?\n(You can get an unfair advantage by doing this and spoil some of your fun.)","Are you sure you want to ghost?","Ghost","Stay in body")
		if(response != "Ghost")
			return	//didn't want to ghost after-all
		ghostize(1)						//0 parameter is so we can never re-enter our body, "Charlie, you can never come baaaack~" :3
	return
