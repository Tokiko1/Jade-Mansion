...
GLOBAL_LIST_INIT(workuniformlist, list(BLACKMAID1, BLACKMAID2, BLACKMAID3, BLACKMAID4, BLACKMAID5,BLACKMAID6, BLACKMAID7, BLUEMAID1, BLUEMAID2, CHEMISTMAID1, BUTLER1, BUTLER2, BUTLER3, OWNERDRESS1, OWNERDRESS2, OWNERDRESS3, CASUALSUIT1, CASUALSUIT2, CASUALSUIT3, DEFAULTJOBSUIT))
