...
GLOBAL_LIST_INIT(workuniformlist, list(BLACKMAID0, BLACKMAID1, BLACKMAID2, BLACKMAID3, BLACKMAID4, BLACKMAID5,BLACKMAID6, BLACKMAID7, BLUEMAID1, BLUEMAID2, KAPPOUGI0, KAPPOUGI1, KAPPOUGI2, KIMONOMAID1, CHEMISTMAID1, CHEMISTMAID2, BUTLER1, BUTLER2, BUTLER3, OWNERDRESS1, OWNERDRESS2, OWNERDRESS3, OWNERDRESS4, OWNERDRESS5, CASUALSUIT1, CASUALSUIT2, CASUALSUIT3, DEFAULTJOBSUIT))
