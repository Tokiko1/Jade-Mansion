...
"Master Chemist" = list("tname" = "Master Chemist", "tdesc" = "You have worked a lot with chemicals. Just looking at a liquid allows you to tell what's inside.", "tcost" = 2, "tnotes" = "This does not apply to liquids in opaque containers.", "active" = null),
"Red Sparrow Martial Artist" = list("tname" = "Red Sparrow Martial Artist", "tdesc" = "You have mastered the Red Sparrow fighting style and have access to special combat moves.", "tcost" = 3, "tnotes" = null, "active" = null),
"Maid Fashion Obsession" = list("tname" = "Maid Fashion Obsession", "tdesc" = "You love maid fashion! So much that not wearing them makes you upset, even if you are not staff.", "tcost" = -1, "tnotes" = "A full uniform includes any of the uniforms, any type of shoe and one of the maid headdresses.", "active" = /datum/trait/maidfashion),
