...
"Disabler Blade" = list("tname" = "Disabler Blade", "tdesc" = "You start with a Disabler Blade. The perfect choice for bodyguards and police, this weapon does stamina damage to enemies and offers melee blocking, counterhits that may send the attacker weapon flying and is very difficult to disarm when unarmed.", "tcost" = 4, "tnotes" = null, "active" = null)
